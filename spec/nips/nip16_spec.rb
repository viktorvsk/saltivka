...
RSpec.describe "NIP-16" do
  describe "regular events" do
    it "saves all regular events" do
  ...
  describe "replaceable events" do
    let(:protocol_exceptions_kinds) { [0, 3, 41] }

    it "deletes replaceable events and keeps the most recent one" do
  ...
  describe "replaceable events with more recent created_at" do
    let(:replaceable_kinds) { [rand(10000...20000), 10000, 19999] }
  ...
  describe "invalid replaceable event" do
  ...
  describe "older replaceable event" do
  ...
  describe "replaceable events with the same created_at" do
  ...
  describe "replaceable events with the same created_at (higher id not saved)" do
